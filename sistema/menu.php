<div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href="inicio.php" target="_blank">
        ...
        <span class="ms-1 font-weight-bold"> SIRC </span>
    </a>
</div>
...
<div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
    <ul class="navbar-nav">
        ...
        <!-- MEDICION -->
        <li class="nav-item">
            <a class="nav-link  " href="mediciones.php">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <title>office</title>
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <span class="nav-link-text ms-1">Mediciones </span>
            </a>
        </li>
        ...
        <!-- TEMATICAS -->
        <li class="nav-item">
            <a class="nav-link  " href="tematicas.php">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <title>office</title>
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <span class="nav-link-text ms-1">Tem&aacute;ticas </span>
            </a>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link  " href="modulos.php">
                ...
                <span class="nav-link-text ms-1">M&oacute;dulos </span>
            </a>
        </li>
